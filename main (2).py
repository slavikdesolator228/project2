...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage(file=r'C:\Users\admin\Desktop\veb9\img\add.png')
        ...
        self.update_img = tk.PhotoImage(file=r'C:\Users\admin\Desktop\veb9\img\update.png')
        ...
        self.delete_img = tk.PhotoImage(file=r'C:\Users\admin\Desktop\veb9\img\delete.png')
        btn_delete = tk.Button(toolbar, bg='#d7d8e0', bd=0, 
                               image=self.delete_img, command=self.delete_records)
        btn_delete.pack(side=tk.LEFT)

        # кнопка поиска
        self.search_img = tk.PhotoImage(file=r'C:\Users\admin\Desktop\veb9\img\search.png')
        btn_search = tk.Button(toolbar, bg='#d7d8e0', bd=0,
                               image=self.search_img, command=self.open_search_dialog)
        btn_search.pack(side=tk.LEFT)

        # кнопка обновления
        self.refresh_img = tk.PhotoImage(file=r'C:\Users\admin\Desktop\veb9\img\refresh.png')
